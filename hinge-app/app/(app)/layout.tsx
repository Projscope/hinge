...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="w-full h-screen bg-bg overflow-hidden flex flex-col">
      {/* Browser chrome bar */}
      <div className="h-[34px] bg-[#1a1915] flex items-center px-3.5 gap-2 border-b border-[var(--border)] flex-shrink-0">
      ...
      {/* App grid */}
      <div className="flex-1 grid overflow-hidden" style={{ gridTemplateColumns: '220px 1fr 290px' }}>
        <Sidebar streaks={streaks} plan={plan} hitRate={hitRate} />

        <main className="overflow-y-auto bg-bg app-scroll animate-fadeUp">
          {children}
        </main>
